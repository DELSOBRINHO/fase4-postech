...
Conectar o branch **`cursor/main-dev-2a05`** ao Streamlit Community Cloud (`app/app.py`), sem alterar o app já publicado no `main`. App: https://precopetroleo.streamlit.app/  
